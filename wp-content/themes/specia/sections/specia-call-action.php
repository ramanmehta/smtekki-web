<?php 
	...
	if($specia_hs_cta == 'on') :
?>
<section id="cta-unique" class="call-to-action-one wow fadeInDown">
            ...
            <div class="row padding-top-25 padding-bottom-25">                
                ...
                <div class="col-md-4 text-md-right flexing flexing-end">
					<?php if($specia_cta_btn_lbl) :?>
						<a href="<?php echo esc_url($specia_cta_btn_link); ?>" <?php if(($specia_cta_btn_target)== 1){ echo "target='_blank'"; } ?> class="bt-primary bt-effect-1 call-btn-1"><?php echo esc_html($specia_cta_btn_lbl); ?></a>
					<?php endif; ?>
